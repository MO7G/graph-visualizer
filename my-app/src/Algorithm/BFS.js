...
const BfsHelper = (gridData) => {
    ...
    constructShortestPath(xStart, yStart, xEnd, yEnd, row, col, counter, vis, grid, path, parent, shortestPath)
...
const constructShortestPath = (xStart, yStart, xEnd, yEnd, row, col, counter, vis, grid, path, parent, shortestPath) => {
    let currentX = xEnd;
    let currentY = yEnd;
